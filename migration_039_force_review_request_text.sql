-- Migration 039: Force review_event_manager_request to TEXT signature only
-- Date: 2026-02-02
-- Description: Remove UUID overloads and ensure text comparison

BEGIN;

DROP FUNCTION IF EXISTS public.review_event_manager_request(UUID, TEXT);
DROP FUNCTION IF EXISTS public.review_event_manager_request(TEXT, TEXT);
